...
export function UploadSection() {
  return (
    <section
      id="upload-section"
      className="min-h-screen w-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-800 relative overflow-hidden flex items-center justify-center p-8"
    >
